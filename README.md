...
If you want to show `hosts.ip_address` but is sorted by another column named `hosts.ip_address_number`:
...
Values can also be Proc objects which will return a `String` or `Arel::Attributes::Attribute` as above.
